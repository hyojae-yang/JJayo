    ...
    public bool CanBuy(PurchasableItemData itemData)
    {
        ...
        switch (itemData.itemType)
        {
            ...
            case ItemType.Consumable:
                if (itemData.consumableData != null && itemData.itemName == "총알(10개)")
                {
